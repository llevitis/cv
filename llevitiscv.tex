...
% Set the path to the font relative to your project's root directory
\newfontfamily{\academicons}{academicons}[Path = ./, Extension = .ttf]
...
% \mbox{elizabeth.levitis @ nih . gov}
% llevitis~{\color{purple} \faGithub}
% LevitisLiza~{\color{blue} \faTwitter}
\section{languages}
...
{London, UK}
{\job{Researcher} \\
Applied best practices for reproducible neuroimaging to organize and process structural, diffusion, and resting-state functional MRI modalities with open-source image processing 
pipelines. Thesis work has focused on characterizing and predicting multimodal imaging phenotypes in individuals 
with sex chromosome aneuploidies as well as using generative deep learning approaches for normative modeling applications in childhood-onset psychiatric disorders.}
...
{Minneapolis, MN}
{Co-supervisor of MSc Student}

\entry
{10/22 -- 12/22}
{University College London}
{London, England}
{\job{Introduction to Machine Learning Teaching Assistant} \\
...
{Minneapolis, MN}
{Hackathon Co-Chair and Organizer}
...
\entry{2023-2024}
{Institute of Healthcare Engineering Impact Fellowship}
...
For an up-to-date list of published code projects, please visit my GitHub profile at https://github.com/llevitis.
