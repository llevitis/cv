...
Responsible for organizing the annual Brainhack event.}
\end{entrylist}
...
{Bethesda, MD}
{\job{BIOL 262 Instructor} \\
Developed and taught a lesson introducing post-baccaulerate students at the NIH to neuroimaging, 
network neuroscience, and applications in biomedical research. Created a programming assignment 
for students to gain practical experience with the methods taught.}
